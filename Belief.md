...
and the theory still hold up to this day, which mean that so far we can consider it fact. when new information on the topic will arise that goes in a different direction will start to talk about possibility's, but so far no such information has apreared after all the reaserch done on the topic.

Dumb internet comment:
"I just don't wanna be a slave to sins,,I'm fighting every temptation that come my way in the name of Jesus Christ AMEN"
My answer:
And you need Christianity for that? (sad) You know the Christ as described by the bible is just a mythological character right? ANEN

Except that in real life the only power of faith is to manipulate people with it, really bad for a society, should be avoided. it's a form of willing ignorance and naivety. faith is the narcissistic reaction to the unknown, even when that unknown can be known. faith has no need for truth or rational in fact it work better if your a fool who has no standard on how to think. faith is fuel for religion which is the worst thing to have happen to this world, they are organisation that specialise in using faith to manipulate. worst they indoctrinate the young with method similar to hypnosis and brainwashing, religions are all just synonymy for sect and cult, they all think their religion is right and all other's are false without having more reason then the other to believe so.


random letter that continue for infinity will at some point contain this exact book. 

What this book is and is not about.
This book do not aim, to explain how some phenomenon have been proven to be wrong. Because their is already enough book and information on the specific explanations of each of those topics. The information is already there for those who
...
all belief are faith based and all faith is blind by definition. so people who use those therm already admit
to willingly ignore reality in favour of conviction.
...
(this apply to most, if no all other religions as well.)
...
The Earth rotate on it self at around 1500km'h at fix velocity depending on the cosine of your latitude.
...
The story of Noa Arch no matter how false it may be might hold a good moral if you look at it from the right perspective, no matter how mighty and superior to other animal you might thinks of your self, where all in the same boat in this story.

No creature has been created FOR us.

Animal indeed are devoid of souls, since soul it self does not exist!
...
your conciusness comes from calculation, that result from an electric current that follow neuronal path, similar to the small logic gates inside your computer, a better example would be a virtual neural netork. but to understand how this work you need to study the topics and the topic does not contain much easy concept to grasp. but we do know it's not due to a soul? all the task that are atributed to the sould, are just process of the brain that have already been explain, their is no trace of the influence of such a thing. 

We cannot trensfer our conciusness the way our neurone are connected to the computer, will will never be able to do such a thing. the issue comes from the definition of a "trensfer" but when computer will have enaugh memory and power we could be able to copy the configuration of a personne brain. their is no missing ingrediant, we just don't have a container big enaugh to containe te recipy.

your action are so much dictated by your neuronal path that using simple electrode we can predict them!

I don't know much about the biology of the brain, it's complex, but do know a lot about programming and simulating things.

I have programmed Virtual world and universe. Virtual creature that have genome and evolvem, Neural network that can solve problems without guidence, I have simulated the same law of phisics that we have in reality using the exact same mathematical formulla to acheave the exact same result. This helped me comprehend how those phenomen actually occure in a way that would have been imposible to most human just 20 years ago. I am not saying this is for avery one, but this is a way i found to play around with those consept that gave me a deep perspective on those topics.

One personne on it self cannot know as much on everithing that a personne can by specialising on a single topics, this is why we have experts that spend their life studing specific topics, and to discredit their expertise in favore of base less belief and assumption is the paroxism of arrogance and narcissist.

Not to say that we cannot question expert if done adequatly or be skeptical of any declaration they make. the issue is to refute theme not because of potential bias or disprovable fact but because of misstrust of expertes in general or because their conclusion do not align with our view of the world, that is what i would describe as a despicable attitude.

you can't know everithing, but the more you know, the less, you believe. at least that's how it works, if your not a completly delusional personne in constent denial of what you know.

less then one percent of philosophers are religious.
Why that might be? maybe because when you start to analyse things and think deeply about them you and up realising that some things make no sens! but that's just my view on what couls be a potential explaination for those statistic.
...
Science: here is the evidence, what conclusion can we draw from it?
 Religions: here is the conclusion, what evidence can we find to support it? What evidence needs to be suppressed so it won't be questioned?
...
Argumentation without argument, has been studied a lot with the different type of bias, accusation and loop holes that a person might use to refuse to admit that they where wrong or that they lost an argument.

Fact do not make excuses, faith does.

Argument for belief are often Argument from ignorance.

A common bias logic of gods believer can be resume to this argument: Look at this puddle here. How could the hole be the exact shape of the water here if it wasn't designed that way.
...
If you are gonna pretend that no one care about something, I can’t wait to know how you collected the opinion of everyone! To arrive at this conclusion.

Something greater then the observable and measurable fact, is another way to say here’s a delusion i would like to share with you, it exist it’s called imagination, it goes beyond reality and should not be confuse with it.
...
Some say that it’s Belief in the value of money that give it it’s value, does that mean that Belief is some time necessary? 

Religion as they are if what they believed was to be true it would be even more suspicious.
In most religious mythology their is a god of lie a god of trickery and deception.

If a god of lie would start a religion what would be it’s core principles? Faith and beliefs, Because if you want to start a religion around your lies, what you need is people who have faith in what you claim, people ready to beliefs in those lies. 
...
[George Carlin (stand-up comedy)](https://www.youtube.com/watch?v=8r-e2NDSTuE)

[Aron Ra](https://www.youtube.com/watch?v=vquOuWx6NlA&t=1173s)
